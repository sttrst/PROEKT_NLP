Добро пожаловать в программу для работы с технологией NLP (natural language processing)!
...
3.2) кнопка со значком корзины очистит output/ для работы с новыми текстами и темами (все файлы classification сохранятся)
...
1) результаты работы задач 1 и 2 можно посмотреть в output/txts/ для первого и output/thms/ с файлом classification для второго
...
4) вклад участников:
    - Даниил Х.   - наш Тим.Лид. / создатель решения задач 1 и 2
    - Игорь С.    - создатель решения задач 1, 2 и их последующего объединения
    - Максиме Ч.  - создатель пользовательского интерфейса и объединения задач 1 и 2
    - Гридунов М. - тестировщик программы, проведший анализ решения
    - Гиршович В. - составитель текста защиты и файла README.txt / спонсор команды
